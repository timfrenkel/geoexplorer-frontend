...
const AdminLocations = () => {
  ...
  return (
    <div className="admin-layout fade-in">
        ...
        <div className="card">
          <div className="card-header">
            <h3 className="card-title">
              {isEditMode ? 'Sehenswürdigkeit bearbeiten' : 'Neue Sehenswürdigkeit'}
            </h3>
            <p className="card-subtitle">
              {isEditMode
                ? 'Passe die Daten einer bestehenden Sehenswürdigkeit an.'
                : 'Füge eine neue Sehenswürdigkeit zur Karte hinzu.'}
            </p>
          </div>
      ...
      <div className="admin-list slide-up">
        <div className="card">
          <div className="card-header">
            <h3 className="card-title">Alle Sehenswürdigkeiten</h3>
            <p className="card-subtitle">
              Klicke auf „Bearbeiten“, um eine Sehenswürdigkeit anzupassen, oder
              deaktiviere sie, falls sie nicht mehr angezeigt werden soll.
            </p>
          </div>
